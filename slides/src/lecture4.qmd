...
- This would mean forcing real-world data such as population to fit a constant increase in the number of people per year.

- This is not realistic, as populations rarely grow in this way.

- Assuming that, at least over some periods, the population will grow at a constant *percentage* rate is often more realistic.
