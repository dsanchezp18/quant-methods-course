...
![Real numbers. Source: Lamar State College](assets/img/real_numbers.png){height=80%}
...
This is a re-statement of the distributive property of addition. For example, if $c = 2$:
...
- A firm sells a product at price $P$ per unit

- **Fixed costs** $FC$: rent, salaries, equipment — paid regardless of output

- **Variable cost** $VC$: materials, labour per unit — scales with quantity $Q$

- Total revenue: $TR = P \cdot Q$; Total cost: $TC = FC + VC \cdot Q$

- The firm **breaks even** when it neither profits nor loses money: $TR = TC$
...
- $(P - VC)$ is the **contribution margin**: how much each unit sold contributes toward covering fixed costs

- Once $Q^*$ units are sold, every additional unit generates profit

# Example: break-even analysis

- A firm has monthly fixed costs of \$10,000, a variable cost of \$6 per unit, and sells at \$16 per unit

$$Q^* = \frac{10{,}000}{16 - 6} = \frac{10{,}000}{10} = 1{,}000 \text{ units}$$

- The firm must sell 1,000 units per month to break even

- For you: a bakery has monthly fixed costs of \$3,000, makes each cake for \$8, and sells it for \$20. How many cakes must they sell to break even?
