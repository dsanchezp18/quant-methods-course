...
- A set of equations that share the same variables is called an *equation system*.
...
![A meme](assets/img/slope.png){height=65%}
...
- If the slope is undefined (division by zero in the slope formula), the line is vertical.
...
- The vertex of the parabola is given by $x = -\dfrac{b}{2a}$.
    ...
    - It has coordinates $\left(\dfrac{-b}{2a}, f\left(\dfrac{-b}{2a}\right)\right)$.
...
- A parabola that opens upwards is called *convex*.
...
- A parabola that opens downwards is called *concave*.
...
- The graph of a cubic function is a curve with an inflection point.

- An inflection point is a point where the curve changes concavity.
...
# Application: comparing cost structures

- A firm needs machinery and can rent from two suppliers:
    - **Supplier A**: \$2,000 flat fee plus \$50 per hour of use
    - **Supplier B**: \$500 flat fee plus \$80 per hour of use

- Write each total cost as a linear equation in hours of use $h$:
...
- Which supplier is cheaper depends on how many hours the firm needs

- The two cost lines intersect at the **indifference point**: the usage level where both suppliers cost the same

# Application: comparing cost structures

- Set $C_A = C_B$ and solve the system:
...
- Below 50 hours, Supplier B is cheaper (lower flat fee)

- Above 50 hours, Supplier A is cheaper (lower hourly rate)

- Graphically, this is exactly the intersection of two lines — the same equation systems we solved earlier

# Example: comparing cost structures

- For you: a gym charges a \$30 flat monthly fee. A second gym charges a \$10 monthly fee plus \$2 per visit.

- How many visits per month make both gyms equally costly?

- Which gym should a member who visits 8 times per month choose?
