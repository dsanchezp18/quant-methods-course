...
- The current tax is 15% of the pre-tax price

- In many Canadian retail settings, taxes are added based on the pre-tax price

- The price after tax can be calculated as $P_{\text{bf}} \cdot 1.15 = 3.50$, so it is $3.50 / 1.15 \approx 3.04$

- The tax is the difference between the pre-tax and final price, so it is $3.50 - 3.04 = 0.46$
...
- Returns to scale are important for understanding the behavior of firms and industries.
    - What kind of production function do you think a fast-food chain might have?
    - How do you think analysts can estimate the production function of a firm?
